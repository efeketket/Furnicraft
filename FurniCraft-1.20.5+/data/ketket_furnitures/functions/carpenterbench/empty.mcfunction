loot replace block ~ ~ ~ container.3 loot ketket_furnitures:benchmenu/empty2
...
loot replace block ~ ~ ~ container.16 loot ketket_furnitures:benchmenu/empty2
loot replace block ~ ~ ~ container.21 loot ketket_furnitures:benchmenu/empty2
loot replace block ~ ~ ~ container.22 loot ketket_furnitures:benchmenu/empty2
...
execute as @s[tag=empty] run data modify entity @s Tags set value ["bench","benchmain","furniture","blockchecker","enabled"]
