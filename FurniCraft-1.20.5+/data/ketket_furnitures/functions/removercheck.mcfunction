...
execute as @s[tag=chair1] positioned ~ ~0.5 ~ run function ketket_furnitures:remover/chairs/removechair1
execute as @s[tag=chair2] positioned ~ ~0.7 ~ run function ketket_furnitures:remover/chairs/removechair2
execute as @s[tag=chair3] positioned ~ ~0.7 ~ run function ketket_furnitures:remover/chairs/removechair3
execute as @s[tag=chair4] positioned ~ ~0.7 ~ run function ketket_furnitures:remover/chairs/removechair4
execute as @s[tag=chair5] positioned ~ ~0.7 ~ run function ketket_furnitures:remover/chairs/removechair5
