...
execute if score @e[type=interaction,sort=nearest,limit=1] mailstoragecounter matches 1 run data modify entity @e[tag=mail,limit=1,sort=nearest] Item set from entity @e[type=item_display,tag=mailstorage,limit=1,sort=nearest] item.tag.Storage[0]
execute if score @e[type=interaction,sort=nearest,limit=1] mailstoragecounter matches 2 run data modify entity @e[tag=mail,limit=1,sort=nearest] Item set from entity @e[type=item_display,tag=mailstorage,limit=1,sort=nearest] item.tag.Storage[1]
execute if score @e[type=interaction,sort=nearest,limit=1] mailstoragecounter matches 3 run data modify entity @e[tag=mail,limit=1,sort=nearest] Item set from entity @e[type=item_display,tag=mailstorage,limit=1,sort=nearest] item.tag.Storage[2]
execute if score @e[type=interaction,sort=nearest,limit=1] mailstoragecounter matches 4 run data modify entity @e[tag=mail,limit=1,sort=nearest] Item set from entity @e[type=item_display,tag=mailstorage,limit=1,sort=nearest] item.tag.Storage[3]
execute if score @e[type=interaction,sort=nearest,limit=1] mailstoragecounter matches 5 run data modify entity @e[tag=mail,limit=1,sort=nearest] Item set from entity @e[type=item_display,tag=mailstorage,limit=1,sort=nearest] item.tag.Storage[4]
