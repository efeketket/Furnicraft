...
execute as @s[tag=connectedc] at @s run kill @e[tag=c,distance=..1]
execute as @s[tag=connectedc] at @s positioned ~-1 ~ ~ run kill @e[tag=a,distance=..1]
...
execute as @s[tag=connectedb] at @s run kill @e[tag=b,distance=..1]
execute as @s[tag=connectedb] at @s positioned ~ ~ ~-1 run kill @e[tag=d,distance=..1]
...
execute as @s[tag=connectedd] at @s run kill @e[tag=d,distance=..1]
execute as @s[tag=connectedd] at @s positioned ~ ~ ~1 run kill @e[tag=b,distance=..1]
