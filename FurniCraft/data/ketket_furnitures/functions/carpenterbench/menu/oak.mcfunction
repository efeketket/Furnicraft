...
execute as @s[tag=woolon9] run loot replace block ~ ~ ~ container.14 loot ketket_furnitures:chairs/chair4/oak
execute as @s[tag=woolon9] run loot replace block ~ ~ ~ container.15 loot ketket_furnitures:chairs/chair3
execute as @s[tag=woolon10] run loot replace block ~ ~ ~ container.14 loot ketket_furnitures:chairs/chair4/oak
