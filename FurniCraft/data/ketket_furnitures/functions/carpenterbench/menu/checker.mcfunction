...
execute as @s[tag=craftedsub,tag=slot9] if data block ~ ~ ~ Items[{Slot:10b}] store result block ~ ~ ~ Items[{Slot:10b}].Count byte 1 run scoreboard players get @s woolcount
execute as @s[tag=craftedsub,tag=slot10] if data block ~ ~ ~ Items[{Slot:9b}] store result block ~ ~ ~ Items[{Slot:9b}].Count byte 1 run scoreboard players get @s woolcount
