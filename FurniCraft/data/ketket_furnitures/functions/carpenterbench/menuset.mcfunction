...
execute as @s[tag=!menuset] if data block ~ ~ ~ Items[{Slot:9b}] run function ketket_furnitures:carpenterbench/return/returnslot9
execute as @s[tag=!menuset] if data block ~ ~ ~ Items[{Slot:10b}] run function ketket_furnitures:carpenterbench/return/returnslot10
