##> place checker
execute as @e[type=player,nbt={SelectedItem:{tag:{furniture:1b}}}] at @s run tag @s add placer
execute as @e[type=player,tag=placer] at @s run function ketket_furnitures:placer

##> click checker
execute as @e[type=interaction,tag=furniture,nbt={attack:{}}] run function ketket_furnitures:click/left
execute as @e[type=interaction,tag=furniture,nbt={interaction:{}}] run function ketket_furnitures:click/right
...
##> sit func
execute as @e[tag=chair,type=interaction,tag=!full] at @s run function ketket_furnitures:sit/fullchecker
