...
execute as @e[type=item_frame,tag=lamp,limit=1] at @s if block ~ ~ ~ minecraft:player_head{SkullOwner:{Id:[I;896492242,-1311094100,-2145777384,-557283891],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmYzNDhmMWEyYTAwZWU1MmFlOGU1NDcxYThlMWUwNmJmNDkzYjAxZDg1ZDJiMTFhZTUzZWY0MGYyZDE1YWE3MyJ9fX0="}]}}} run function ketket_furnitures:place/lamps/lamp1

kill @e[type=item_frame,tag=lamp,distance=..6]