#balance
scoreboard objectives add balanceshow trigger
...
scoreboard objectives add playtimeshow trigger

#booshop
scoreboard objectives add item_count dummy
scoreboard objectives add selling dummy
scoreboard objectives add placeshop trigger
...
scoreboard objectives add shopnamevisible trigger