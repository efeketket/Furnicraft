execute as @e[tag=1] at @e run clear @a magma_cream{display:{Name:'{"text":"Magma Krem","bold":true,"italic":false}'}} 8
execute as @s store result score @s item_count run clear @s minecraft:magma_cream 0
...
execute as @s[scores={selling=1}] run clear @s minecraft:magma_cream 8
execute as @s[scores={selling=1}] run tellraw @s ["",{"text":"8x","bold":true,"color":"gold"},{"text":" Magma Krem başarıyla satıldı!","color":"yellow"}]
