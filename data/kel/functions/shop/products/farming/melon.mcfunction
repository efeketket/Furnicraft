execute as @e[tag=1] at @e run clear @a melon{display:{Name:'{"text":"Karpuz","bold":true,"italic":false}'}} 16
...
execute as @s[scores={selling=1}] run clear @s minecraft:melon 16
execute as @s[scores={selling=1}] run tellraw @s ["",{"text":"x16","bold":true,"color":"gold"},{"text":" Karpuz başarıyla satıldı!","color":"yellow"}]
