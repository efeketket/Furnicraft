execute as @e[tag=1] at @e run clear @a golden_carrot{display:{Name:'{"text":"Altın Havuç","bold":true,"italic":false}'}} 16
execute as @s store result score @s item_count run clear @s minecraft:golden_carrot 0
...
execute as @s[scores={selling=1}] run clear @s minecraft:golden_carrot 16
execute as @s[scores={selling=1}] run tellraw @s ["",{"text":"16x","bold":true,"color":"gold"},{"text":" Altın Havuç başarıyla satıldı!","color":"yellow"}]
