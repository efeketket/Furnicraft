execute as @e[tag=1] at @e run clear @a bamboo{display:{Name:'{"text":"Bambu","bold":true,"italic":false}'}} 128
...
execute as @s[scores={selling=1}] run tellraw @p ["",{"text":"x128","bold":true,"color":"gold"},{"text":" Bambu başarıyla satıldı!","color":"yellow"}]
