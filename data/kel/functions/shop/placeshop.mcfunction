...
execute if score @s shop_count matches ..2 run execute as @s run summon armor_stand ~ ~-1 ~ {Invisible:1b,Invulnerable:1b,NoGravity:1b,CustomName:'{"text":"Satış Kutusu"}',CustomNameVisible:1b,Tags:["1"]}
