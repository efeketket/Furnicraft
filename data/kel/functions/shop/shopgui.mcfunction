...
#drop item page 5
execute as @e[tag=1,scores={page=5},limit=1] unless block ~ ~1 ~ chest{Items:[{Slot:13b}]} run execute at @e[tag=1,scores={page=5}] as @p[limit=1,sort=nearest,distance=..5] run function kel:shop/empty_check
